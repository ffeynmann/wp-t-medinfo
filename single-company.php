...
$departments && $department = $departments[0]->term_id;
...
$department && $args['department_id'] = $department;
...
<!--                <div class="badge-wrapper">-->
                    <?php foreach ($postData['departments'] as $department): ?>
                        <a href="<?= $department['link'] ?>" class="badge no-pointer active"><?= $department['title'] ?></a>
                    <?php endforeach; ?>
<!--                </div>-->
            </div>
                ...
                <div class="left">
                    ...
                    <span class="stars-wrapper">
                        ...
                        <span class="vue-inst d-inline-block m564">
                            <stars m_class="md ml-2" level="<?= $postData['rating'] ?>"></stars>
                        </span>
                        <?php if($postData['ratings_count']): ?>
                        <span class="d-inline-block ml-1 font-color-1"><?= sprintf('(%d)', $postData['ratings_count']) ?></span>
                        <?php endif ?>
                    </span>
                    ...
                    <template v-if="locations && locations.length">
                        ...
                        <company-locations :value="location" :locations="locations"
                                           v-if="locations.length > 1" v-model="location"></company-locations>
                    </template>
...
<!--            </div>-->
        ...
        <div class="vue-inst mt-10">
            <form-review data-post="<?= $post->ID ?>" data-symbols-limit="2000"></form-review>
        </div>
    </div>
